...
import '../basketball_config.dart';
import 'settings_screen.dart';
import '../../shared/screens/saved_matches_screen.dart';
...
class _BasketballScreenState extends State<BasketballScreen> {
  ...
  void initState() {
    ...
    // Initialize with basketball defaults immediately so UI renders
    statTypes = BasketballConfig.getDefaultStatTypes();
    positions = BasketballConfig.getDefaultPositions();
    _loadData();
  }
  ...
  Future<void> _exportMatch() async {
    ...
    try {
      ...
      final fileName = 'match_sheet_${DateTime.now().millisecondsSinceEpoch}';
