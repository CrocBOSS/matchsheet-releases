              ...
              children: [
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: currentRating == rating ? Colors.orange : Colors.grey[200],
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: currentRating == rating ? Colors.white : Colors.black,
                        ),
                      ),
                    ),
                  );
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 8),
                    decoration: BoxDecoration(
                      color: currentRating == 0 ? Colors.orange : Colors.grey[200],
                      borderRadius: BorderRadius.circular(4),
                    ),
                    child: Text(
                      'Clear',
                      ...
                      style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                        color: currentRating == 0 ? Colors.white : Colors.black,
                      ),
                    ),
                  ),
                ),
